...
public class A5Tester {
	...
	public static void testDoubleAll() {
		...
		A5Exercises.doubleAll(arr3);
		displayResults(Arrays.equals(arr3, expected4), "double all values in arr3");
		
		A5Exercises.doubleAll(arr4);
		displayResults(Arrays.equals(arr4, expected5), "double all values in arr4");
